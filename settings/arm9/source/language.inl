...
STRING(DESCRIPTION_FONT, "Select which font to use in Settings and the Nintendo DSi, Nintendo 3DS, SEGA Saturn, and Homebrew Launcher themes.")
...
STRING(DESCRIPTION_PHOTO_BOXART_COLOR_DEBAND, "Increases color range of the photo and/or box art/game covers. Disable this, if you encounter a freeze in the DSi, 3DS, Saturn, or HBL themes.")
...
STRING(A78_ROMS, "Atari 7800 ROMs")
...
STRING(GBARUNNER2_NATIVE, "GBARunner2 > Native")
...
STRING(DESCRIPTION_SHOW_A78, "Display Atari 7800 ROMs in the ROM list.")
...
STRING(SYSSD_SMSGGINRAM, "Sys SD: Load SMS/GG ROM into RAM")
STRING(GBABORDER, "GBA border")
STRING(RUNIN, "Run in")
STRING(SYSSD_RUNIN, "Sys SD: Run in")
STRING(CPUSPEED, "ARM9 CPU Speed")
STRING(SYSSD_CPUSPEED, "Sys SD: ARM9 CPU Speed")
STRING(VRAMBOOST, "VRAM boost")
STRING(SYSSD_VRAMBOOST, "Sys SD: VRAM boost")
STRING(USEBOOTSTRAP, "Use nds-bootstrap")
STRING(USEBOOTSTRAP_B4DS, "Use nds-bootstrap (B4DS)")
...
STRING(SD_EXPANDROMSPACE, "SD: Expand ROM space in RAM")
